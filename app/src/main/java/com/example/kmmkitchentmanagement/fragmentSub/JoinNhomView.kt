...
class JoinNhomView : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_chitietnhomjoin, container, false)
    }
                    ...
                    if (!members.contains(userId)) {
                        ...
                        nhomRef.update(mapOf(
                            ...
                            .addOnSuccessListener {
                                ...
                                fragmentTransaction.replace(R.id.NhomJoinView, frag_Nhom()) // Chuyển đến danh sách nhóm
